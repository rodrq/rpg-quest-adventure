...
class ErrorCode:
    ...
    EMPTY_SELECTED_CHARACTER = "No selected character to generate quest for."
    ...
    LAST_QUEST_NOT_COMPLETED = "You need to complete your previous quest before generatin a new one"
